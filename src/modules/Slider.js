...
class Slider {
    selectors = {
        ...
        previousBtn:'[data-js-slider-previous-button]',
        nextBtn:'[data-js-slider-next-button]',
    ...
    constructor(rootElement){
        ...
        this.previousBtnElement = this.navigationElement.querySelector(this.selectors.previousBtn)
        this.nextBtnElement = this.navigationElement.querySelector(this.selectors.nextBtn)
    ...
    init(){
        new Swiper(this.swiperElement, {
            ...
            navigation:{
                prevEl:this.previousBtnElement,
                nextEl:this.nextBtnElement
            },
            pagination:{
